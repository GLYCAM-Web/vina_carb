...
//This func is moved to common.hpp
...
//const double chpi_miu = 4.49, chpi_sigma = 0.75, chpi_const = 0.26; //Yao:Parameters in 2023, fit to complex ADE
//const double g_denominator = 1.125, g_coeff = 0.1383;
